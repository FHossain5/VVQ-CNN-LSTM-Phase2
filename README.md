...
![Figure 1. Uncalibrated scatter](visuals/fig2_uncalibrated_scatter.png)

### Figure 2. Calibration (Calibrated)
Test video-level predictions after linear mapping. Dashed line: ideal y = x. 

![Figure 2. Calibrated scatter](visuals/fig1_calibrated_scatter.png)

### Figure 3. Residuals vs MOS (Calibrated)
Residuals defined as: (True MOS − Predicted MOS). 

![Figure 3. Residuals vs MOS](visuals/fig3_residuals_vs_mos.png)
...
![Figure 4. PLCC by QP](visuals/fig4_plcc_by_qp.png)
...
![Figure 5. Grad-CAM examples](visuals/fig8_gradcam_examples.png)
